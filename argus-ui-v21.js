(()=>{
  ...
  function installHeader(){
    ...
    header.innerHTML=`<div class="v21-brand"><div class="v21-mark">A</div><div class="v21-brandcopy"><strong>ARGUS OMNI</strong><small>FOOTBALL INTELLIGENCE</small></div></div><div class="v21-app-actions"><button class="v21-refresh" type="button" aria-label="Refresh ARGUS">↻</button></div>`;
  ...
  function rebuildCommand(){
    ...
    root.dataset.v21='1';
    root.innerHTML=`
      <div class="v21-daynav" aria-label="Match day"><span class="v21-daylabel">TODAY</span><time>${fmtDate()}</time></div>
      <div class="v2-status-strip">
        <div><span>PRIME</span><strong id="v2Prime">0</strong></div>
        <div><span>VALUE</span><strong id="v2Value">0</strong></div>
        <div><span>WAIT</span><strong id="v2Watch">0</strong></div>
        <span id="v2NoBet" hidden>0</span>
      </div>
      <div class="v2-best-line"><span>Best signal</span><strong id="v2Best">Ready when you are</strong><small id="v2Updated">—</small></div>
      <div class="v2-filterbar" role="tablist"><button data-v2-filter="signals" class="active">Best</button><button data-v2-filter="prime">Prime</button><button data-v2-filter="value">Value</button><button data-v2-filter="watch">Wait</button><button data-v2-filter="all">All</button></div>`;
  ...
  function updateCounts(){
    try{
      ...
      }else set('v2Best','No eligible opportunity right now');
