...
function compactCandidate(c=null){if(!c)return null;return{side:c.side||c.selection||null,selection:c.selection||c.side||null,label:c.label||null,marketType:c.marketType||null,line:c.line??null,probability:c.probability??null,probabilityPct:c.probabilityPct??null,modelProbability:c.modelProbability??null,modelProbabilityPct:c.modelProbabilityPct??null,odds:c.odds??null,edgePct:c.edgePct??null,rawEdgePct:c.rawEdgePct??null,ev:c.ev??c.evPct??null,evPct:c.evPct??null,fairOdds:c.fairOdds??null,decisionScore:c.decisionScore??null,dataQuality:c.dataQuality??null,source:c.source||null,modelVersion:c.modelVersion||null,validationStatus:c.validationStatus||null,marketProbability:c.marketProbability??null,marketProbabilityPct:c.marketProbabilityPct??null,marketFusion:c.marketFusion?{mode:c.marketFusion.mode||null,modelWeight:c.marketFusion.modelWeight??null,marketWeight:c.marketFusion.marketWeight??null,rawEdgePct:c.marketFusion.rawEdgePct??null,fusedEdgePct:c.marketFusion.fusedEdgePct??null,edgeRetentionPct:c.marketFusion.edgeRetentionPct??null,conservativePrior:c.marketFusion.conservativePrior===true,trainedSecondStage:c.marketFusion.trainedSecondStage===true}:null,mathIntegrity:c.mathIntegrity||null,marketView:c.marketView?{rawImplied:c.marketView.rawImplied??null,adjustedImplied:c.marketView.adjustedImplied??null,priceDeviationPct:c.marketView.priceDeviationPct??null,marketSignalStrength:c.marketView.marketSignalStrength??null}:null}}
